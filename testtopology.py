...
def Config(net, args):
    ...
    A.cmd("xterm -xrm 'XTerm.vt100.allowTitleOps: false' -T A &")
    A.cmd("xterm -xrm 'XTerm.vt100.allowTitleOps: false' -T A &")
    A.cmd("xterm -xrm 'XTerm.vt100.allowTitleOps: false' -T A &")
    B.cmd("xterm -xrm 'XTerm.vt100.allowTitleOps: false' -T B &")
    B.cmd("xterm -xrm 'XTerm.vt100.allowTitleOps: false' -T B &")
    C.cmd("xterm -xrm 'XTerm.vt100.allowTitleOps: false' -T C &")
    C.cmd("xterm -xrm 'XTerm.vt100.allowTitleOps: false' -T C &")
    D.cmd("xterm -xrm 'XTerm.vt100.allowTitleOps: false' -T D &")
    D.cmd("xterm -xrm 'XTerm.vt100.allowTitleOps: false' -T D &")
    E.cmd("xterm -xrm 'XTerm.vt100.allowTitleOps: false' -T E &")
    E.cmd("xterm -xrm 'XTerm.vt100.allowTitleOps: false' -T E &")
    E.cmd("xterm -xrm 'XTerm.vt100.allowTitleOps: false' -T E &")
